...
объекта (например, если класс объявлявлен как final)
...
пользоваться методом clone() придется делать преобразование типа самостоятельно. 
...
/*  Проблема данной реализации - в рекурсии. Она выглядит красиво и при 
 ...
 можем получить переполнение стека вызовов. Наилучший вариант в данном случае -
...
/*  Выглядит не так изящно, как рекурсия, зато работает наверняка.*/
