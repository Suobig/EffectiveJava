...
метод equals никогда не будет вызван. В таких случаях возможно стоит 
...
только тогда, когда y.equals(x) = true
    3) транзитивность. Для любых ненулевых x, y, z: если  x.equals(y) = true и
y.equals(z) = true, то x.equals(z) = true
    4) постоянство. Для любых ненулевых x, y повторные вызовы equals() должны
возвращать одинаковый результат, если никакй из используемых при сравнении 
элементов этих объектов не был изменен
